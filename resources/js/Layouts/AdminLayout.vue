      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 justify-between items-center">
          ...
          <div class="flex items-center space-x-3">
            <div class="flex items-center justify-center px-3.5 py-1.5 min-w-[76px] rounded-xl bg-[#1E2B7B] text-white font-black text-base tracking-wider shadow-sm border border-red-400/50 shrink-0">
              <span class="text-white">NOO</span><span class="text-rose-300 ml-0.5">+</span>
            </div>
            <div>
