      ...
      <div class="space-y-4">
        ...
        <div class="p-4 bg-emerald-50/70 border border-emerald-200 rounded-xl flex items-center justify-between">
          ...
          <button
            ...
            class="px-3 py-1.5 text-xs font-semibold text-white bg-[#059669] hover:bg-[#047857] rounded-lg transition shadow-xs whitespace-nowrap shrink-0 flex items-center gap-1.5"
          >
